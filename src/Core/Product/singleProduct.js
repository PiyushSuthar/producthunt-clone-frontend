    ...
    const ProductInfo = () => (
        <>
            ...
            <div style={ { display: "flex", flexDirection: "row" } }>
                ...
                <div style={ { padding: "10px", maxWidth: "30%", height: "100%" } } className="information_links">
                    <a target="_blank" rel="noopener noreferrer" href={ data.link }>
                        <Button style={ { padding: "10px", width: "100%" } }>Visit  <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKCAYAAACNMs+9AAAAQElEQVR42qXKwQkAIAxDUUdxtO6/RBQkQZvSi8I/pL4BoGw/XPkh4XigPmsUgh0626AjRsgxHTkUThsG2T/sIlzdTsp52kSS1wAAAABJRU5ErkJggg==" alt="" /></Button>
                    </a>
                    <WhiteBackgroundDiv style={ { display: "flex", flexDirection: "column" } }>
